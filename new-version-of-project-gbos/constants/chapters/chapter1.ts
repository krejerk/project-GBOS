...
export const CHAPTER1_KEYWORDS: Record<string, KeywordMetadata> = {
  ...
  'missing': { id: 'missing', chapter: 1, type: 'case', displayName: '失踪', isPersistent: true, description: '1970年代起频繁发生的失踪事件，疑与家族旅行轨迹重合。', source: 'Briefing' },
  'asian_woman': { id: 'asian_woman', chapter: 1, type: 'person', displayName: '亚裔女性', isPersistent: true, description: '失踪案中的受害者特征之一。', source: 'Briefing' },
  'nibi': { id: 'nibi', chapter: 1, type: 'person', displayName: '尼比', description: '阿尔衮琴特人，康查尔在狱中的"狱友"，曾被控参与缅因州银行劫案。', source: 'Confession' },
  'year_1971': { id: 'year_1971', chapter: 1, type: 'year', displayName: '1971', isPersistent: true },
  'year_1968': { id: 'year_1968', chapter: 1, type: 'year', displayName: '1968', isPersistent: true },
  'year_1967': { id: 'year_1967', chapter: 1, type: 'year', displayName: '1967', isPersistent: true },
  'dr_reggie': { id: 'dr_reggie', chapter: 1, type: 'person', displayName: '雷吉博士', isPersistent: true, isIdentity: true, description: '卡彭的上线，"统一场论"的提出者。', source: 'Investigation' },
  'roger_beebe': { id: 'roger_beebe', chapter: 1, type: 'person', displayName: '罗格·毕比', description: '香槟镇失踪案的真凶。', source: 'Confession' },
  'year_1985': { id: 'year_1985', chapter: 1, type: 'year', displayName: '1985', isPersistent: true },
  'family': { id: 'family', chapter: 1, type: 'case', displayName: '家庭', isPersistent: true, description: '卡彭潜入的目标组织，一个以血缘为纽带的犯罪团伙。', source: 'Confession' },
};
...
export const CHAPTER1_NODES: MemoryNode[] = [
  {
    ...
    layers: {
      [MemoryLayer.SURFACE]: {
        event: "日子过去实在太久了。这些年我喝了这么多劣质波本，脑子早被搞坏了。所以我要提醒你，不管我说了什么，它都有可能只是我为了不发疯，而一遍遍讲给自己听的‘故事’。\n\n你说的缅因州的案子应该发生在1971年，是雷吉博士当时标记案件中的最新一起。当 KLUB 获得了实质上的行动经费之后，雷吉的几个学生，通过一些退伍军人俱乐部的关系，锁定了名叫尼比的阿尔衮琴人，局里的行动组很快对其实施抓捕。被捕后的尼比对罪行供认不讳，很快就被审判收监起来。抓人当然不是雷吉博士的目的，所以没过几天，他们也把我也放到监狱里，和尼比关在一起。",
        attitude: "",
