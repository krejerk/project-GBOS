...
import { MemoryNode, MemoryLayer, ClueAttachment } from './types';
...
export const KEYWORD_CONSUMPTION_MAP: Record<string, string[]> = {
  ...
  'confession_10': ['recruitment', 'boris_smirnov'],
  ...
  'confession_17': ['dirty_frank', 'recruitment'],
  'confession_18': ['denver_suburb', 'police_killing'],
  ...
  'va_1972': ['martha_diaz', 'year_1972', 'roanoke', 'year_1990'],
  'va_1990': ['aw_wilmo', 'year_1990'],
  'cin_1973': ['julie', 'year_1973', 'mint_plan'],
  ...
  'archive_22': ['frank_rollins', 'year_1977', 'tucson_shooting', 'precinct_4'],
  'archive_23': ['capone', 'year_1983'],
  'confession_33': ['precinct_4', 'tucson_shooting'],
};

// Categorization and Metadata for Keywords
export interface KeywordMetadata {
  id: string;
  type: 'location' | 'case' | 'person' | 'year';
  displayName: string;
  chapter: number;
  isPersistent?: boolean; // Survives chapter transitions if not used
  isIdentity?: boolean;   // Survives Jennifer's purge (identity anchors)
  isArchiveOnly?: boolean; // If true, only appears in the Dossier/Archive, not in the general search hint box
  description?: string;   // Optional detailed description for the library
  source?: string;        // Optional source attribution (e.g., "Briefing")
  attachments?: ClueAttachment[]; // Optional associated evidence
}


export const KEYWORD_REGISTRY: Record<string, KeywordMetadata> = {
  // --- NODE 1: Initial Investigation (Briefing) ---
  'maine': { id: 'maine', type: 'location', displayName: '缅因州', chapter: 1, isPersistent: true, description: '该家族曾在此地实施过一次银行劫案。', source: 'Briefing' },
  'small_bank': { id: 'small_bank', type: 'case', displayName: '小银行', chapter: 1, isPersistent: true, description: '被家族劫掠的目标地点之一。', source: 'Briefing' },
  'ohio': { id: 'ohio', type: 'location', displayName: '俄亥俄州', chapter: 1, isPersistent: true, description: '1968年柯特兰邪教屠杀案的发生地。雷吉博士"统一场论"列表中的关键案件之一。', source: 'Confession' },
  'ritual_case': { id: 'ritual_case', type: 'case', displayName: '祭祀案', chapter: 1, isPersistent: true, description: '伦德格兰以宗教祭祀为名义实施的屠杀。艾弗里一家五口在谷仓下被杀害。', source: 'Confession' },
  'lundgren': { id: 'lundgren', type: 'person', displayName: '伦德格兰', chapter: 1, isPersistent: true, description: '柯特兰邪教屠杀案的主谋，自称能与神灵沟通。其行为带有强烈的表演性与仪式感。', source: 'Confession' },
  'chicago': { id: 'chicago', type: 'location', displayName: '芝加哥', chapter: 1, isPersistent: true, description: '亚裔女性失踪案发生的周边城市。', source: 'Briefing' },
  'missing': { id: 'missing', type: 'case', displayName: '失踪', chapter: 1, isPersistent: true, description: '受害者的最终下落不明。', source: 'Briefing' },
  'asian_woman': { id: 'asian_woman', type: 'person', displayName: '亚裔女性', chapter: 1, isPersistent: true, description: '在香槟镇失踪的受害者。', source: 'Briefing' },
  'nibi': { id: 'nibi', type: 'person', displayName: '尼比', chapter: 1, description: '阿尔衮琴人，1971年缅因州银行劫案的执行者。与康查尔之间存在扭曲的仪式性关系。', source: 'Confession' },
  'year_1971': { id: 'year_1971', type: 'year', displayName: '1971', chapter: 1, isPersistent: true, description: '缅因州银行劫案发生的年份，也是卡彭潜伏任务开始的时间节点。', source: 'Confession' },
  'year_1968': { id: 'year_1968', type: 'year', displayName: '1968', chapter: 1, isPersistent: true, description: '俄亥俄州柯特兰邪教屠杀案发生的年份。雷吉博士的案卷病理学分析揭示了伦德格兰的真实动机。', source: 'Confession' },
  'year_1967': { id: 'year_1967', type: 'year', displayName: '1967', chapter: 1, isPersistent: true },
  'dr_reggie': { id: 'dr_reggie', type: 'person', displayName: '雷吉博士', chapter: 1, isPersistent: true, isIdentity: true, description: '招募卡彭执行潜伏任务的关键人物。提出了"统一场论"，认为多个冷案之间存在隐藏的共性。', source: 'Confession' },
  'roger_beebe': { id: 'roger_beebe', type: 'person', displayName: '罗格·毕比', chapter: 1, description: '香槟镇失踪案的真凶。1985年因另一起案件被捕后，主动承认了1980年绑架并杀害金美善的罪行。', source: 'Confession' },
  'year_1985': { id: 'year_1985', type: 'year', displayName: '1985', chapter: 1, isPersistent: true, description: '罗格·毕比被捕并供认香槟镇失踪案的年份。FBI内部对KLUB机构的重组也在这一年启动。', source: 'Confession' },
  'family': { id: 'family', type: 'case', displayName: '诡异家族', chapter: 1, isPersistent: true, description: '一个庞大的、横跨全美的家族式犯罪团伙。成员之间通过血缘连接，行踪飘忽不定。', source: 'Briefing' },
  'julip': { 
    id: 'julip', 
    type: 'case', 
    displayName: '黄油朱莉普', 
    ...
    source: 'Briefing',
    attachments: [
        { id: 'julip_symbol', type: 'image', title: 'FBI Symbol Sketch', content: './assets/fbi-symbol.png' },
        { id: 'butter_julep_evidence', type: 'image', title: 'Butter Julep Evidence (1973)', content: './assets/butter_julep_evidence.jpg', description: '1973年辛辛那提少女冻死案证物。热感成像技术扫描显示，毛毯上残留着一个由高纯度工业油脂与未知染料混合而成的热敏化学印记。' },
        { id: 'richie_id_card', type: 'image', title: 'Richie Dreyfuss ID Card (1977)', content: './assets/richie_id_card.jpg', description: '1977年印第安纳沙丘州立公园发现的里奇·德莱弗斯驾驶证。' },
        { id: 'libby_ticket', type: 'image', title: 'Greyhound Ticket Stubs', content: './assets/libby_ticket.jpg', description: '内容物是19张打过孔的灰狗巴士旧票根，时间跨度十二年，全部是单程票。目的地同一个地点，蒙大拿州西北部的利比镇。' }
    ]
  },
  
  // --- NODE 2: Growing Connections ---
  '1402_old_dominion_rd': { id: '1402_old_dominion_rd', type: 'location', displayName: '1402 Old Dominion Rd.', chapter: 2, isPersistent: true, description: '罗伯特·卡彭接受特殊训练的地点。也是雷吉博士对他进行“特殊观察”的场所。', source: 'Briefing' },
  'training_day': { id: 'training_day', type: 'case', displayName: '训练日', chapter: 2, isPersistent: true, description: 'RC受训结束的日子。在那一天，雷吉博士向他揭示了被选中的真相。', source: 'Dialogue' },
  'nevada': { id: 'nevada', type: 'location', displayName: '内华达州', chapter: 2, description: 'RC多次活动的地点。在他的梦境中，那是“青豆牡蛎汤”的起源地。', source: 'Confession' },
  'family_massacre': { id: 'family_massacre', type: 'case', displayName: '灭门案', chapter: 2, isPersistent: true, description: '戈尔康达郡发生的灭门惨案。RC曾在现场留下生物特征，被标记为高风险接触。', source: 'Briefing' },
  'mojave_rest_stop': { id: 'mojave_rest_stop', type: 'location', displayName: '莫哈韦休息站', chapter: 2, isPersistent: true },
  'empty_cigarette_pack': { id: 'empty_cigarette_pack', type: 'case', displayName: '空烟盒', chapter: 2, isPersistent: true },
  'roanoke': { id: 'roanoke', type: 'location', displayName: '罗阿诺克', chapter: 2, isPersistent: true },
  'twisted_relationship': { id: 'twisted_relationship', type: 'case', displayName: '扭曲关系', chapter: 2, description: '尼比与康查尔之间存在某种超越普通同伙的、带有仪式感的肉体与精神链接。', source: 'Confession' },
  'little_derek_wayne': { id: 'little_derek_wayne', type: 'person', displayName: '小德里克·维恩', chapter: 2 },
  'year_1972': { id: 'year_1972', type: 'year', displayName: '1972', chapter: 2 },
  'year_1990': { id: 'year_1990', type: 'year', displayName: '1990', chapter: 2 },
  'project': { 
    id: 'project', 
    type: 'case', 
    displayName: '青豆牡蛎汤计划', 
    ...
    attachments: [
        ...
        { type: 'image', title: '无名氏（Jane Doe）与起火的车辆', content: './assets/jane_doe_1977.jpg', description: '记录了1977年图森沙漠中，一名无名氏（Jane Doe）背对起火的警车走向荒野的背影。' }
    ]
  },

  // --- NODE 3: The Expanding Web ---
  'louisville': { id: 'louisville', type: 'location', displayName: '路易斯维尔', chapter: 3 },
  'blue_rv': { id: 'blue_rv', type: 'case', displayName: '淡蓝色房车', chapter: 3, description: '卡彭记忆回路中频繁出现的视觉锚点，被认为是家族流动的作案中心。' },
  'cincinnati': { id: 'cincinnati', type: 'location', displayName: '辛辛那提', chapter: 3 },
  'mint_plan': { id: 'mint_plan', type: 'case', displayName: '薄荷计划', chapter: 3, isPersistent: true },
  'burkesville': { id: 'burkesville', type: 'location', displayName: '伯克斯维尔', chapter: 3, isPersistent: true },
  'distant_relatives': { id: 'distant_relatives', type: 'case', displayName: '远亲', chapter: 3 },
  'klub75_report': { id: 'klub75_report', type: 'case', displayName: 'KLUB-75号分析报告', chapter: 3, isPersistent: true },
  'quantico': { id: 'quantico', type: 'location', displayName: '匡提科', chapter: 3, isPersistent: true },
  'kansas_city': { id: 'kansas_city', type: 'location', displayName: '堪萨斯城', chapter: 3, isPersistent: true },
  'mobile_blood_truck': { id: 'mobile_blood_truck', type: 'case', displayName: '流动献血车', chapter: 3, isPersistent: true, description: '在堪萨斯城引发恐慌的怪诞事件，后被证实为针对莫里西的嫁祸行动。', source: 'Confession' },
  'year_1973': { id: 'year_1973', type: 'year', displayName: '1973', chapter: 3, isPersistent: true },
  'boris_smirnov': { id: 'boris_smirnov', type: 'person', displayName: '鲍里斯·斯米尔诺夫', chapter: 3, description: '一名被称为“远亲”的家族成员，参与了伯克斯维尔的行动。', source: 'Confession' },
  'year_1986': { id: 'year_1986', type: 'year', displayName: '1986', chapter: 3, isPersistent: true },
  'year_1975': { id: 'year_1975', type: 'year', displayName: '1975', chapter: 3, isPersistent: true },
  'graywater_beacon': { 
    id: 'graywater_beacon', 
    type: 'case', 
    displayName: '灰水信标', 
    chapter: 3, 
    isPersistent: true,
    description: '在莫哈韦休息站附近发现的视觉残留信号。代号"灰水信标"，是KLUB计划中用于单向情报传递的载具系统。可通过铁马烟盒上的记录进行识别。', 
    source: 'Confession',
    attachments: [
        { id: 'iron_horse_beacon', type: 'image', title: '铁马烟盒 (Iron Horse)', content: './assets/iron_horse_beacon.jpg' }
    ]
  },
  'view_iron_horse_record': {
    id: 'view_iron_horse_record',
    type: 'case',
    displayName: '烟盒记录：路易斯维尔',
    chapter: 3,
    isPersistent: true,
    description: '詹妮弗提供的一份关键记录，揭示了卡彭最后一次信标投放的地理坐标：肯塔基州路易斯维尔。',
    source: 'Jennifer',
    attachments: [
        { 
          ...
          description: '烟盒内侧潦草地记录着：[路易斯维尔](clue:louisville)。'
        }
    ]
  },

  // --- NODE 4: Deep Fragments ---
  'st_louis': { id: 'st_louis', type: 'location', displayName: '圣路易斯', chapter: 4, isPersistent: true, description: '密苏里州的一座城市。', source: 'Archive' },
  'maggots': { id: 'maggots', type: 'case', displayName: '蛆虫', chapter: 4, isPersistent: true, description: 'FBI探员霍华德·贝克在早期档案中对那些流浪汉或干扰者的贬称。', source: 'Archive' },
  'davenport': { id: 'davenport', type: 'location', displayName: '达文波特', chapter: 4, isPersistent: true, description: '爱荷华州的一座城市。康查尔曾带着他的“新计划”前往此处。', source: 'Confession' },
  'new_plan': { id: 'new_plan', type: 'case', displayName: '新计划', chapter: 4, isPersistent: true, description: '康查尔在圣路易斯行动后制定的秘密方案，具体内容仍然模糊。', source: 'Confession' },
  'texarkana': { id: 'texarkana', type: 'location', displayName: '特克萨卡纳', chapter: 4, isPersistent: true, description: '横跨三州的抛尸地。这里的地理特征与碎尸案的执行手法高度关联。', source: 'Dialogue' },
  'dismemberment_case': { id: 'dismemberment_case', type: 'case', displayName: '碎尸案', chapter: 4, isPersistent: true, description: '一起手段极其残忍的案件，是雷吉计划中用于摧毁目标人格稳定性的核心事件。', source: 'Archive' },
  'year_1976': { id: 'year_1976', type: 'year', displayName: '1976', chapter: 4, isPersistent: true },
  'year_1965': { id: 'year_1965', type: 'year', displayName: '1965', chapter: 4, isPersistent: true },
  'john_morrissey': { id: 'john_morrissey', type: 'person', displayName: '约翰·莫里西', chapter: 4, isPersistent: true },
  'peter_henderson': { id: 'peter_henderson', type: 'person', displayName: '皮特·亨德森', chapter: 4, isPersistent: true },
  'martha_diaz': { 
    id: 'martha_diaz', 
    type: 'person', 
    displayName: '玛莎·迪亚兹', 
    chapter: 2, 
    description: '罗阿诺克市“洁净人生”自助洗衣店的店员，死于康查尔之手。', 
    source: 'Confession' 
  },
  'east_12th_st': { id: 'east_12th_st', type: 'location', displayName: '东12街', chapter: 4, isPersistent: true },
  'execution_room': { id: 'execution_room', type: 'case', displayName: '行刑室', chapter: 4, isPersistent: true },
  'recruitment': { id: 'recruitment', type: 'case', displayName: '招募', chapter: 4, isPersistent: true, description: '雷吉博士筛选并引导卡彭进入“统一场论”计划的过程。', source: 'Dialogue' },
  
  // --- NODE 5: High Risk Transitions ---
  'dirty_frank': { id: 'dirty_frank', type: 'location', displayName: '脏弗兰克酒吧', chapter: 5, isPersistent: true, description: '康查尔与卡彭的暂住地，莫宁经营的据点。', source: 'Confession' },
  'denver_suburb': { id: 'denver_suburb', type: 'location', displayName: '丹佛市郊', chapter: 5, isPersistent: true },
  'police_killing': { id: 'police_killing', type: 'case', displayName: '警员遇害案', chapter: 5, isPersistent: true },
  'el_paso': { id: 'el_paso', type: 'location', displayName: '埃尔帕索', chapter: 5, isPersistent: true, description: '边境城市，著名的情报中转站。许多被“采集”的样本或人员在这里消失。', source: 'Dialogue' },
  'priest': { id: 'priest', type: 'person', displayName: '牧师', chapter: 5, isPersistent: true, description: '活跃在埃尔帕索的中转站关联人物。', source: 'Dialogue' },
  'church': { 
    id: 'church', 
    type: 'location', 
    displayName: '教堂', 
    chapter: 5, 
    isPersistent: true, 
    description: '在埃尔帕索发现的一个节点。', 
    source: 'Dialogue',
    attachments: [
        { id: 'church_visual_residue', type: 'image', title: 'Visual Residue: El Paso Church', content: './assets/church_visual_residue.png', description: '检测到的视觉残留。一个模糊的身影在教堂角落观察着一切。' }
    ]
  },
  'interstate_80': { id: 'interstate_80', type: 'location', displayName: '80号洲际公路', chapter: 5 },
  'watchman': { id: 'watchman', type: 'case', displayName: '守夜人', chapter: 5 },
  'year_1977': { id: 'year_1977', type: 'year', displayName: '1977', chapter: 5 },
  'year_1974': { id: 'year_1974', type: 'year', displayName: '1974', chapter: 5, isPersistent: true, description: '莫宁锁定时间轴的关键年份。', source: 'Dialogue' },
  'morning': { id: 'morning', type: 'person', displayName: '莫宁', chapter: 5, isPersistent: true, description: '脏弗兰克酒吧的老板，经营着报废车场。', source: 'Confession' },
  'richie_dreyfuss': { id: 'richie_dreyfuss', type: 'person', displayName: '里奇·德莱弗斯', chapter: 5, isPersistent: true },

  // --- NODE 6: Awakening ---
  'portland': { id: 'portland', type: 'location', displayName: '波特兰', chapter: 6 },
  'achilles_heel': { id: 'achilles_heel', type: 'case', displayName: '软肋', chapter: 6 },
  'redwood_forest': { id: 'redwood_forest', type: 'location', displayName: '红杉林', chapter: 6 },
  'pow_camp': { id: 'pow_camp', type: 'location', displayName: '战俘营', chapter: 6 },
  'santa_barbara': { id: 'santa_barbara', type: 'location', displayName: '圣芭芭拉', chapter: 6 },
  'closing_the_net': { id: 'closing_the_net', type: 'case', displayName: '收网', chapter: 6 },
  'laguna_beach': { id: 'laguna_beach', type: 'location', displayName: '拉古那海滩', chapter: 6 },
  'naked_root': { id: 'naked_root', type: 'case', displayName: '裸根', chapter: 6 },
  'albuquerque': { id: 'albuquerque', type: 'location', displayName: '阿尔伯克基', chapter: 6 },
  'chemist_lover': { id: 'chemist_lover', type: 'case', displayName: '化学家情人', chapter: 6 },
  'santa_fe': { id: 'santa_fe', type: 'location', displayName: '圣菲', chapter: 6 },
  'bonny_and_clyde': { id: 'bonny_and_clyde', type: 'case', displayName: '邦妮和克莱德', chapter: 6 },
  'alexei': { id: 'alexei', type: 'person', displayName: '阿列克谢', chapter: 6, isPersistent: true },
  'morandi': { id: 'morandi', type: 'person', displayName: '莫兰迪', chapter: 6, isPersistent: true },
  'gore_and_levy': { id: 'gore_and_levy', type: 'person', displayName: '戈尔和列维探员', chapter: 6, description: 'FBI探员，于1976年在拉古那海滩监视房车时被卡彭杀害。', source: 'Confession' },

  // --- NODE 7: Final Pieces ---
  'mill_valley': { id: 'mill_valley', type: 'location', displayName: '米尔谷', chapter: 7, isPersistent: true },
  'reporter': { id: 'reporter', type: 'case', displayName: '记者', chapter: 7, isPersistent: true, description: '加里·韦伯斯特。一位调查报道记者。', source: 'Archive' },
  'fake_smoke_bomb': { id: 'fake_smoke_bomb', type: 'case', displayName: '人造烟雾弹', chapter: 7, isPersistent: true, isArchiveOnly: true },
  'blind_zone_camp': { id: 'blind_zone_camp', type: 'location', displayName: '盲区营地', chapter: 7, isPersistent: true },
  'woodland_depths': { id: 'woodland_depths', type: 'location', displayName: '林地深处', chapter: 7 },
  'amalekite_protocol': { id: 'amalekite_protocol', type: 'case', displayName: '亚玛力人协议', chapter: 7 },
  'libby_town': { id: 'libby_town', type: 'location', displayName: '利比镇', chapter: 7, description: '蒙大拿州西北部一个靠近边境的偏僻伐木区。卡彭在过去十几年中多次前往。', source: 'Dialogue' },
  'tithe': { id: 'tithe', type: 'case', displayName: '什一税', chapter: 7, isPersistent: true },
  'humphrey_county': { id: 'humphrey_county', type: 'location', displayName: '汉弗莱县', chapter: 7, description: '密西西比州的一个县。1967年曾发生过严重暴力冲突。', source: 'Archive' },
  'assault_on_police': { id: 'assault_on_police', type: 'case', displayName: '袭警案', chapter: 7, description: '发生在汉弗莱县的严重暴力事件。', source: 'Archive' },
  'forest_map': { id: 'forest_map', type: 'case', displayName: '森林地图', chapter: 7, description: '在记忆碎片中发现的详细地图，标注了蒙大拿州利比镇周边的原始森林区域。', source: 'Confession' },
  'frank_rollins': { id: 'frank_rollins', type: 'person', displayName: '弗兰克·罗林斯', chapter: 7 },
  'precinct_4': { id: 'precinct_4', type: 'location', displayName: '第4号警务站', chapter: 7 },
  'tucson_shooting': { id: 'tucson_shooting', type: 'case', displayName: '图森枪战案', chapter: 7 },
  'william_dawson': { id: 'william_dawson', type: 'person', displayName: '威廉·道森', chapter: 2, description: '利比镇的木材商。', source: 'Confession' },
  'cynthia_miller': { id: 'cynthia_miller', type: 'person', displayName: '辛西娅·米勒', chapter: 3, description: '“静态雪花计划”的受害者。', source: 'Confession' },
  'wanted_poster': { id: 'wanted_poster', type: 'case', displayName: '通缉令', chapter: 7, isArchiveOnly: true, description: '一份关于费利佩·马尔多纳多的通缉令。', source: 'Project' },
  'felipe_maldonado': { id: 'felipe_maldonado', type: 'person', displayName: '费利佩·马尔多纳多', chapter: 7, description: '一名与家族活动有关的乐团负责人，其海报曾出现在废弃的林地中。', source: 'Confession' },
  'year_1983': { id: 'year_1983', type: 'year', displayName: '1983', chapter: 7, isPersistent: true },
  'aw_wilmo': { id: 'aw_wilmo', type: 'person', displayName: '小 A.W.威尔莫', chapter: 2, description: '“清理小组”成员。在1972年罗阿诺克市的信标投放中，他曾负责后续的回收工作。', source: 'Confession' },
  
  // --- IDENTITY ANCHORS: Always stay ---
  'capone': { id: 'capone', type: 'person', displayName: '罗伯特·卡彭', chapter: 7, isIdentity: true, isPersistent: true, description: '潜伏阶段使用的身份代号，KLUB计划的重点关注对象。', source: 'Confession' },
  'robert': { id: 'robert', type: 'person', displayName: '罗伯特', chapter: 7, isIdentity: true, isPersistent: true },
  'vanessa': { id: 'vanessa', type: 'person', displayName: '瓦妮莎', chapter: 4, isIdentity: true, isPersistent: true },
  'jennifer': { id: 'jennifer', type: 'person', displayName: '詹妮弗', chapter: 0, isIdentity: true, isPersistent: true },
  'personnel_tree': { 
    id: 'personnel_tree', 
    type: 'case', 
    displayName: '人物关系 (Personnel)', 
    description: '基于目前掌握的线索，整理出的相关人物关系网络演进图。',
    chapter: 0, 
...
export const CATEGORY_IDS = {
  LOCATIONS: Object.values(KEYWORD_REGISTRY).filter(k => k.type === 'location').map(k => k.id),
  CASES: Object.values(KEYWORD_REGISTRY).filter(k => k.type === 'case').map(k => k.id),
  PEOPLE: Object.values(KEYWORD_REGISTRY).filter(k => k.type === 'person').map(k => k.id),
  YEARS: Object.values(KEYWORD_REGISTRY).filter(k => k.type === 'year').map(k => k.id),
};

export const CLUE_DISPLAY_MAP: Record<string, string> = Object.values(KEYWORD_REGISTRY).reduce((acc, k) => {
  acc[k.id] = k.displayName;
  return acc;
}, {} as Record<string, string>);

export const GLOBAL_KEYWORD_MAP: Record<string, { id: string, type: 'clue' | 'year' | 'person' | 'location' | 'archive' }> = {
  ...Object.values(KEYWORD_REGISTRY).reduce((acc, k) => {
    const type = k.type === 'case' ? 'clue' : (k.type === 'year' ? 'year' : (k.type === 'person' ? 'person' : 'location'));
    acc[k.displayName] = { 
      id: k.id, 
      type: type 
    } as any;
    
    // Auto-generate Chinese year variants for all years
    if (k.type === 'year') {
      acc[k.displayName + '年'] = { id: k.id, type: 'year' };
    }
    
    return acc;
  }, {} as any),
  
  // Custom aliases and variants for robust matching
...
/**
 * UNLOCKS_REGISTRY
 * Central mapping of keyword combinations to game targets (confessions/archives).
 */
export const UNLOCKS_REGISTRY: Record<string, {
  keywords: string[];
  targetId: string;
  type: 'node' | 'archive';
  message?: string;
...
export const ARCHIVE_CASE_HIGHLIGHT_MAP: Record<string, string[]> = {
  ...
  'archive_15': ['圣路易斯', '雷吉博士'],
  // archive_16: annotation mentions 丹佛市郊 (location) and 警员遇害案 (case)
  'archive_16': ['丹佛市郊', '警员遇害案'],
  // oh_1968: newspaper contains 俄亥俄州 directly; annotation contains 1967 (year→archive search), 1968 is removed
  'oh_1968': ['1967'],
  // dc_1967: title and annotation mention 碎尸案 (case)
  'dc_1967': ['碎尸案'],
  // va_1972: annotation mentions 罗阿诺克 (location cross-ref in va_1990 context) and 1990
  'va_1972': ['1990', '1990年'],
  ...
  'nv_1971': ['莫哈韦休息站', '空烟盒'],
  // cin_1973: annotation mentions 薄荷计划 (case); 1973 is year→archive search
  'cin_1973': ['薄荷计划'],
  ...
  'archive_23': ['capone', 'year_1983', '圣泉镇'],
...
// Archive Evidence Highlighting Mapping
...
export const CORE_NODES: MemoryNode[] = [
  ...
  },
  {
    ...
    layers: {
      ...
      [MemoryLayer.DEEP]: {
        event: "卢西亚诺负责分发那些'特制汤'。他死在卡彭怀里，临死前手里紧握着一根注射器。",
        attitude: "他太软弱了。他以为自己在喂食大家，其实他只是在为建筑师挑选祭品。"
      }
    },
    connectedTo: ["gbos"]
  },
...
毫无疑问，哪怕 RDX 的爆炸当量能把整栋房子化为齑粉，这块铭牌也只会像颗弹片一样嵌进砖缝里。它会幸存下来，被二十年后某个筛网筛土的联邦探员捡到。`,
        attitude: "",
        visual: "https://picsum.photos/seed/confession27/800/450"
      },
      [MemoryLayer.DEEP]: {
        event: "",
        attitude: ""
...
不会是康查尔吧，莫非他还在缅因州监狱的时候就已经成为线人了？`,
  ...
  },
  {
    ...
    revealedKeywords: ['nibi', 'conchar', 'dr_reggie', 'year_1971', 'twisted_relationship'],
    excludedKeywords: ['maine', 'small_bank'],
    layers: {
      [MemoryLayer.SURFACE]: {
  ...
  },
  {
    ...
    revealedKeywords: ['lundgren', 'morning'],
    excludedKeywords: ['year_1968', 'ohio', 'ritual_case', 'maine', 'nibi'],
    layers: {
      [MemoryLayer.SURFACE]: {
  ...
  },
  {
    ...
    excludedKeywords: ['missing', 'chicago'],
    layers: {
      [MemoryLayer.SURFACE]: {
        event: "孩子，我先给你正确答案吧。\n\n失踪案的真凶名叫罗格·毕比，就是警方最早怀疑的那个嫌疑人。实话告诉你，要不是 KLUB 存心指错了路，警方五年前就该把他带走了。直到1985年他因为别的案子被捕，竟然主动承认香槟镇那档子事也是他干了。",
        attitude: "",
