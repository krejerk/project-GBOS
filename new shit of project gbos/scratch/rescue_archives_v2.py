...
if top_idx == 0 or bottom_idx == 0:
    print(f"Boundaries not found: top={top_idx}, bottom={bottom_idx}")
    sys.exit(1)

rescue_top = lines[:top_idx+1]
# We need to close the {activeCase && ( branch and <div> wrapper if they were open in top_idx
# Actually, top_idx is right after /* RESULT VIEW ... */
# So the next line should be 735: <div className="w-full h-full flex flex-col relative bg-black overflow-hidden">

rescue_bottom = lines[bottom_idx:]

# Construct a clean Result View
