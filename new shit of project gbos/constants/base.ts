...
export const BRIEFING_SECTIONS = [
  ...
  },
  {
    id: 5,
    title: '证言记录 - 03',
    content: '有一次，一伙罪犯劫掠了[缅因州](clue:maine)的某个[小银行](clue:small_bank)，人们提到蒙面人中有两人佩戴阿尔衮琴族头饰，另一次，[芝加哥](clue:chicago)附近的香槟镇上，一个亚裔女性在离开大学图书馆后[失踪](clue:missing)了。一些本地人说她回到了身在远东的前夫身边，另外一些人的怀疑则更合理，他们声称，凶手是本地的一名深居简出的公开恋童者。',
  },
  {
    id: 6,
    title: '证言记录 - 04',
