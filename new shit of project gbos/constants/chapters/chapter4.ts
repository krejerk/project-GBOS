...
export const CHAPTER4_KEYWORDS: Record<string, KeywordMetadata> = {
  ...
  'jc_penney': { id: 'jc_penney', chapter: 4, type: 'person', displayName: "杰西·潘尼", isPersistent: true },
...
export const CHAPTER4_NODES: MemoryNode[] = [
  {
    ...
    layers: {
      ...
      [MemoryLayer.DEEP]: { event: "“从[1965](clue:year_1965)起，那个爱尔兰杂种在堪萨斯盘踞了十年。”父亲咬了一口苹果，咀嚼的声音在安静的车厢里格外清晰，“他是个毫无审美的屠夫，把人拆碎了卖，就像卖猪肉一样。我曾经试图……感化他，让他明白规矩，但他太傲慢了。”\n\n“而你，我的孩子。你只是为了好玩，画了一幅画，摆了几个塑料人偶……你就做到了联邦政府十年都做不到的事。你不需要搜查令，不需要证据，你只是制造了一点点混乱，就让那一整座坚固的堡垒从内部塌陷了。”", attitude: "", visual: "" },
