...
export const CHAPTER3_NODES: MemoryNode[] = [
  {
    ...
    layers: {
      ...
      [MemoryLayer.CORE]: { event: "走进那辆淡蓝色的车厢，我第一次见到了其他人。\n\n母亲坐在阴影里，苍白得近乎透明，膝盖上放着一盆还在冒热气的碎肉。与此同时，一个强壮如同灰熊的男人正靠在舱壁上，擦拭一根沉重的钢管。他看着我的眼神里充满了某种带有生理性的恶意，直到康查尔上前拥抱，并告诉我，他叫塞勒斯。就在这时，一个女孩靠上前来，给我递过一块热毛巾，然后飞快消失了，我注意到她的眼睛里闪过一丝幸存者才会有的悲悯，这让我有些犹豫，我不知道自己为什么犹豫。我听康查尔叫她“甜肉”（sweet meat），父亲也叫她“甜肉”，这个称呼如此自然亲切，却又像在恭维盘子里的食物一般。\n\n后来我知道女孩名叫瓦妮莎，但在跟其他人在一起时，我也只能叫她“甜肉”。\n\n无论如何，就在那晚的昏暗灯光下，我看着赛勒斯肆无籍惮地把手伸进母亲的衣襟，而父亲则沉默地注视着这一切，顺手理了理瓦妮莎的长发。我瞬间明白了，这辆房车里没有任何伦理可言，有的只是通过交配建立的纽带，平等而明确。\n\n此时的我并不清楚，这种由乱伦堆砌的纽带，比其他关系要牢固一千倍。", attitude: "", visual: "" }
    }
  },
  {
    id: "confession_9",
