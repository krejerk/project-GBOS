...
export interface GameState {
  phase: 'studio-intro' | 'title' | 'briefing' | 'briefing-detail' | 'dialogue' | 'immersion';
  ...
  tutorialStep?: number; // Current tutorial step (0 = not active/complete, 1, 2, etc.)
  isTutorialComplete?: boolean; // Whether the tutorial has been completed
  history: Array<{
  ...
  branchAttemptCount?: number;
  isBranchLocked?: boolean;
  hasSeenEndingA?: boolean;
